...
public class Banco {
    ...
    static File caminho = new File("C:\\Users\\ryan1\\OneDrive\\Documentos\\Aula_19_07");
    static File arquivoCc = new File(caminho, "ContaCorrente.db");
    static File arquivoCp = new File(caminho, "ContaPoupaça.db");

    public static ContaCorrente[] leArquivo(){
        ContaCorrente[] lista = new ContaCorrente[20];

        try{
            ObjectInputStream leitura = new ObjectInputStream(new FileInputStream(arquivoCc.getAbsolutePath()));
